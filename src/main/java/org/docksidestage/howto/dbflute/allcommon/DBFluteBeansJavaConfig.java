...
import org.docksidestage.howto.dbflute.allcommon.DBFluteInitializer;
 ...
 */
@Configuration
@ComponentScan(value="org.docksidestage.howto.dbflute.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new org.docksidestage.howto.dbflute.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new org.docksidestage.howto.dbflute.allcommon.ImplementedInvokerAssistant();
    }
